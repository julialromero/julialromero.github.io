...
<section class="home-hero" aria-labelledby="home-title">
  ...
  <div class="home-hero__content">
    ...
    <div class="home-linkbar" aria-label="Profile links">
      ...
      <a href="{{ '/files/Julia_Romero_CV.pdf' | relative_url }}" class="profile-text-link">[CV]</a>
    </div>
  </div>
</section>
...
<section class="home-section home-bio" id="bio" aria-labelledby="about-me">
  <div class="section-heading-row">
    <div>
      <p class="home-bio__notice">I am seeking Research Scientist roles in AI/ML, especially in computer vision, foundation models and self-supervised learning, and sensing systems.</p>
  ...
  <div class="publication-list" aria-label="Publications">
    ...
    <article class="publication-item publication-item--with-thumb">
      ...
      <div class="publication-body">
        ...
        <div class="publication-title-row">
          <p class="publication-title">&ldquo;Long-form Reasoning for Keystep Recognition using Graph Neural Networks.&rdquo;</p>
          <div class="publication-links" aria-label="Publication links">
            ...
            <a href="https://youtu.be/iz2Flo4ZVm4?t=2472" class="publication-link" aria-label="Video link" data-label="Video of award and spotlight talk">
              <svg class="publication-link__icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                <path d="M21.58 7.19a2.98 2.98 0 0 0-2.1-2.1C17.62 4.5 12 4.5 12 4.5s-5.62 0-7.48.59a2.98 2.98 0 0 0-2.1 2.1A31.24 31.24 0 0 0 1.83 12c0 1.62.2 3.23.59 4.81a2.98 2.98 0 0 0 2.1 2.1c1.86.59 7.48.59 7.48.59s5.62 0 7.48-.59a2.98 2.98 0 0 0 2.1-2.1c.39-1.58.59-3.19.59-4.81s-.2-3.23-.59-4.81ZM10 15.5v-7l6 3.5-6 3.5Z"/>
              </svg>
            </a>
          </div>
        </div>
        <p class="publication-meta">International Conference on Computer Vision Workshops (ICCVW), 2025</p>
        <p class="publication-note publication-note--award"><span class="publication-award-icon" aria-hidden="true"><svg viewBox="0 0 24 24" focusable="false"><path d="M7 2.75h10a1.25 1.25 0 0 1 1.25 1.25v1.5A4.25 4.25 0 0 1 15 9.64v1.23a4.64 4.64 0 0 1-2.25 3.98v2.15h3a.75.75 0 0 1 0 1.5H8.25a.75.75 0 0 1 0-1.5h3v-2.15A4.64 4.64 0 0 1 9 10.87V9.64A4.25 4.25 0 0 1 5.75 5.5V4A1.25 1.25 0 0 1 7 2.75Zm8 1.5v1.25A2.75 2.75 0 0 0 16.75 7.99 2.75 2.75 0 0 0 16.75 5.5V4.25H15Zm-7.75 0v1.25a2.75 2.75 0 0 0 1.75 2.49A2.75 2.75 0 0 0 9 5.5V4.25H7.25Z"/></svg></span>1st place, Meta's Ego-Exo4D Keystep Recognition Challenge for Video Understanding</p>
